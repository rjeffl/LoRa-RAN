# Bridge Node — engineering log, 2026-09-17 to 2026-09-23

**Dated record, moved here unedited on 2026-09-26 and never rewritten.** These entries run
from M22's idle arm on 2026-09-17 to BF-27's dummy publish on 2026-09-23: the receive-loss
investigation (M22, M25, the D1 captures), BF-32, BF-23, BF-34, V-B12 and BF-24 to BF-27.
They were moved out of [`engineering-log.md`](./engineering-log.md) because it had grown past
3,700 lines. The live log continues from 2026-09-24. Entries from 2026-09-10 to 2026-09-16
are in [`engineering-log-2026-09-10_2026-09-16.md`](./engineering-log-2026-09-10_2026-09-16.md).
Where this disagrees with a document, the document is the current statement and this is
