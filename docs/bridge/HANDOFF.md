...
**The bridge board runs `e08f4b1`, BF-37 and BF-38, flashed on 2026-09-25** from a clean
tree. **Both simnodes run `75a3ed0`**, spec v0.15's code, flashed the same day. The bridge holds `cmd_retries` 3, its default, as an
