...
| `2026-09-04-walk-gatelink.csv` | **R10 position walk, the first real M6 data — and, unrecognised until 2026-09-09, the only well-bearing measurement this project has.** **P3 is survey site 3 `welllink-well`**, ~100 m out, 2.08 % PER, the thinnest margin any node site showed and the only position with `phy_crc_err`. **P3's recorded fix is wrong rather than coarse**, and correcting its distance moves it from worst to fourth in the excess-loss table, falsifying "the barn costs most". All of it is in the file's own header, dated. **And "six positions on the gate bearing" was always loose** — P5 faces SW, P6 faces SE and P3 is the well; they are six *node and waypoint* positions around one fixed initiator, not one bearing. Six positions, P0 the fixed initiator at the house. 1152 probes, 2 lost downlink, 7 lost uplink; no dead test points. **Not a clear-field test:** the initiator was indoors at the bridge's target location, so every path crosses at least one framed wall, and P5/P6 cross the house. **Position 7 is not a location.** Height was 2–4 ft, not the 1.2 m the capture note claimed. All three are explained in the file's own header. Read it with the resplog below. |
